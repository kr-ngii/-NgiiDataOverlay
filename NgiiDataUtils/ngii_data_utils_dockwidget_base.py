...
#
# Created: Tue Apr 03 19:25:44 2018
...
class Ui_NgiiDataUtilsDockWidgetBase(object):
    def setupUi(self, NgiiDataUtilsDockWidgetBase):
        ...
        NgiiDataUtilsDockWidgetBase.resize(232, 460)
        ...
        self.gridLayout_3.addWidget(self.btnLoadVector, 0, 0, 1, 2)
        self.btnLoadImage = QtGui.QPushButton(self.dockWidgetContents)
        self.btnLoadImage.setObjectName(_fromUtf8("btnLoadImage"))
        self.gridLayout_3.addWidget(self.btnLoadImage, 1, 0, 1, 2)
        self.btnLoadTms = QtGui.QPushButton(self.dockWidgetContents)
        self.btnLoadTms.setObjectName(_fromUtf8("btnLoadTms"))
        self.gridLayout_3.addWidget(self.btnLoadTms, 2, 0, 1, 2)
        self.btnLoadWms = QtGui.QPushButton(self.dockWidgetContents)
        self.btnLoadWms.setObjectName(_fromUtf8("btnLoadWms"))
        self.gridLayout_3.addWidget(self.btnLoadWms, 3, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.prgSub, 4, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.prgMain, 5, 0, 1, 2)
        self.lblStatus = QtGui.QLabel(self.dockWidgetContents)
        self.lblStatus.setEnabled(False)
        self.lblStatus.setObjectName(_fromUtf8("lblStatus"))
        self.gridLayout_3.addWidget(self.lblStatus, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.scrollArea, 7, 0, 1, 2)
        spacerItem = QtGui.QSpacerItem(20, 117, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem, 8, 0, 1, 2)
    ...
    def retranslateUi(self, NgiiDataUtilsDockWidgetBase):
        ...
        self.btnLoadWms.setText(_translate("NgiiDataUtilsDockWidgetBase", "최신 국토기본정보 불러오기", None))
