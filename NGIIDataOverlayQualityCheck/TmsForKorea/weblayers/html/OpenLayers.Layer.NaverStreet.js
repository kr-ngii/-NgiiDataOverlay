...
OpenLayers.Layer.NaverStreet = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    // https://simg.pstatic.net/onetile/get/194/0/0/12/3354/2874/bl_vc_bg/ol_vc_an
    name: "네이버지도",
    url: [
    "http://onetile1.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
    "http://onetile2.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
    "http://onetile3.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
    "http://onetile4.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an"
    // "https://simg.pstatic.net/onetile/get/194/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an"
    ],
