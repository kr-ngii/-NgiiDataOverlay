...
OpenLayers.Layer.NaverHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    "http://onetile1.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_rd/ol_st_an",
    "http://onetile2.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_rd/ol_st_an",
    "http://onetile3.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_rd/ol_st_an",
    "http://onetile4.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_st_bg/ol_st_rd/ol_st_an"
    ],
